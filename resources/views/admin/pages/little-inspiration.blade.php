...
<div class="content-wrapper">
    ...
    <section class="content">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Tour Photos</a>
            </li>
            <li class="nav-item">
                ...
                <div class="col-md-12">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <!-- Section 1 -->
                            <form action="{{ route('admin.little.updatesection') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="addPhotoModal" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('little.upload.file') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" id="fileType" name="fileType" value="photo">
                                                <div class="form-group">
                                                    <label for="tourfile">Select Tour Photo</label>
                                                    <input type="file" class="form-control" id="tourfile" name="tourfile"></input>
                                                </div>
                                                <div class="form-group">
                            ...
                            <table class="table mt-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>
                                            <img src="{{ $photo->file_path }}" alt="" srcset="" width="250">
                                        </th>
                                        <td>{{ $photo->title }}</td>
                                        <td>{{ $photo->description }}</td>
                                        <td>
                                            <a href="file/delete/{{ $photo->id }}" class="btn btn-sm btn-danger">Delete</button>
                                                <br>
                                                <a style="margin-left:10%" href="photo/view-edit/{{ $photo->id }}" class="btn btn-sm btn-success">Edit</a>
                                                @if($photo->is_active==1)
                                                <a style="margin-left:10%" href="file/deactive-active/{{ $photo->id }}/deactive" class="btn btn-sm btn-danger">Deactive</a>
                                                @else
                                                <a style="margin-left:10%" href="file/deactive-active/{{ $photo->id }}/active" class="btn btn-sm btn-danger">Active</a>
                                                @endif
                                        </td>
                                    </tr>
                                    @endforeach
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('little.upload.file') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" id="placeholderImage" name="placeholderImage"></input>
                                                </div>
                                                <div class="form-group">
                            ...
                            <table class="table mt-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a style="margin-right:10%" href="file/view-edit/{{ $video->id }}" class="btn btn-sm btn-success">Edit</button>
                                                <a href="file/delete/{{ $video->id }}" class="btn btn-sm btn-danger">Delete</button>
                                                    @if($video->is_active==1)
                                                    <a style="margin-left:10%" href="file/deactive-active/{{ $video->id }}/deactive" class="btn btn-sm btn-danger">Deactive</a>
                                                    @else
                                                    <a style="margin-left:10%" href="file/deactive-active/{{ $video->id }}/active" class="btn btn-sm btn-danger">Active</a>
                                                    @endif
                                        </td>
                                    </tr>
                                    @endforeach
