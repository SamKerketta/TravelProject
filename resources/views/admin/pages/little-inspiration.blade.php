                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <form action="{{ route('admin.little.updatesection') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="section1Heading" name="section1Heading"></input>
                                </div>
                                <div class="form-group">
                            ...
                            <table class="table mt-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="file/view-edit/{{ $video->id }}" class="btn btn-sm btn-success">Edit</button>
