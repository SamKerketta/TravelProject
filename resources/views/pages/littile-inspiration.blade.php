...
<section class="hero" style="position:relative; ">
    <div class="banner">
        <img src="images/little-inspirations/Inspirational%20Adventures.webp" class="d-block w-100" alt="Luxury Travels Bali">
    </div>
                ...
                <div class="experiences-box">
                    <div class="exper-cont" style="padding-top:99px;">
                        <div class="content">
                            ...
                            <button style=""><a href="https://www.alphonsostories-partners.com/partner-login?From_Url=/experiences" style="text-decoration:none;color:white;">View All Experiences</a></button>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="trips-rsp">
    <div class="container-fluid">
                    ...
                    <div onclick="thevid=document.getElementById('thevideo'); thevid.style.display='block'; this.style.display='none'">
                        <div class="play-button-wrapper">
                            <div title="Play video" class="play-gif" id="circle-play-b">
                                <!-- SVG Play Button -->
                                <img src="images/icons/play-icon.png" alt="" srcset="" style="width: 100px; position:absolute; top:200px;">
                            </div>
                        </div>
        ...
        <div class="row" style="padding:0px 30px 36px 36px; margin-bottom: 60px;">
            ...
            <div class="col-lg-4">
                <div class="litt-trav">
                    <div onclick="thevid=document.getElementById({{ $elemtnId }}); thevid.style.display='block'; this.style.display='none'">
                        <div class="play-button-wrapper">
                            <div title="Play video" class="play-gif" id="circle-play-b">
                                <!-- SVG Play Button -->
                                <img src="images/icons/play-icon.png" alt="" srcset="" style="width: 20%;position:absolute;height: 90px;top: 50px;">
                            </div>
                        </div>
...
<section>
    <div class="PopShwMnVriBkle" style="display: none;">
        <div class="SurciseSecSwn">
            ...
            <div>
                <h5>Disclaimar</h5>
                <p>To Explore our collection, please contact us on <a href="mailto:littleinspirations@distinctdestinations.in">
