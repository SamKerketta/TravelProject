            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="hero-title" style="text-align:center;">
                        <h2 style="font-size:4.5rem;line-height: .8em; color:#000;">DESTINATIONS</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="about_p">
                            <p style="font-size:16px; text-align: center !importent;">
                                <strong>
                                    ...
                                    factors, including the type of paint, surface, humidity,
                                    and temperature. erature. Spray paint drying time can
                                    vary based on several factors, including the type of
                                    paint, surface, humidity, and temperature.
                                </strong>
                            </p>
                            <br>
                            <p style="font-size:16px;text-align: center !importent;">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 inner-section innner-content">
                    <div class="about_main2">
                        <div class="about_main3">
                            <div class="about-h">
                                <h3 style="margin-bottom:47px;text-align:right;font-weight: bold;">LUXURY IN INDIA</h3>
                            </div>
                            <div class="about_p">
    ...
    <section class="trips-bg">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12 inner-section">
                    <div class="about-img1">
                        <img src="images/home/destinations/nepal.jpg" alt="about">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12 inner-section innner-content">
                    <div class="about_main">
    ...
    <section class="trips-bg">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12 inner-section">
                    <div class="about-img1">
                        <img src="images/home/destinations/bhutan.jpg" alt="about">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12 inner-section innner-content">
                    <div class="about_main">
    ...
    <section class="trips-bg" style="padding:0px;">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 inner-section">
                    <div class="about-img2">
                        <img src="images/home/destinations/bhutan_1.jpg" alt="about">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="trips-bg">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12 inner-section">
                    <div class="about-img1">
                        <img src="images/home/destinations/sri_lanka_2.jpg" alt="sri_lanka_2">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12 inner-section innner-content">
                    <div class="about_main">
    ...
    <section class="trips-bg" style="padding-bottom: 60px;">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 inner-section">
                    <div class="about-img2">
                        <img src="images/home/destinations/srilanka.jpg" alt="srilanka">
                    </div>
                </div>
            </div>
        </div>
